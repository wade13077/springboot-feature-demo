...
public class TodoService {
    ...
    static {
        todos.add(new Todo(++todoCount, "wade", "Learn AWS Cloud",
                LocalDate.now().plusYears(1), false));
        todos.add(new Todo(++todoCount, "wade", "Learn DevOps",
                LocalDate.now().plusYears(2), false));
        todos.add(new Todo(++todoCount, "wade", "Learn Full Stack Development",
